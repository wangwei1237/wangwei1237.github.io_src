...
function makeIcon(style, pluginConfig) {
    if (style == "info") {
        return '<div class="hints-icon"><img src="https://wangwei1237.gitee.io/tip.png" /></div>';
    } else if (style == "tip") {
        return '<div class="hints-icon"><img src="https://wangwei1237.gitee.io/note.png" /></div>';
    } else if (style == "danger") {
        return '<div class="hints-icon"><img src="https://wangwei1237.gitee.io/warn.png" /></div>';
    } else {
