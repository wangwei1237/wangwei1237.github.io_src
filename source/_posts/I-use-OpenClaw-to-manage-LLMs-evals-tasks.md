...
## 后记
后来，在学习 Anthropic 的 [Harness design for long-running application development](https://www.anthropic.com/engineering/harness-design-long-running-apps) 时，里面对解决模型所面临的上下文窗口焦虑问题时所提到的方案[^9]：
...
这与我们在 Main Agent 中通过 Cron 来定期创建新的 Status Agent 有异曲同工之处。
...
[^9]: [Harness design for long-running application development](https://www.anthropic.com/engineering/harness-design-long-running-apps)